...
<footer>&copy; 2026 Albums Studio &bull; Video Style Interaction</footer>
...
document.querySelectorAll('video').forEach(video=>{
    ...
    video.addEventListener('timeupdate',()=>{ progress.value = (video.currentTime/video.duration)*100; });
