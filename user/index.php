...
.hero-subtitle { font-size: 14px; text-transform: uppercase; letter-spacing: 6px; color: var(--secondary); margin-bottom: 20px; display: block; }
...
.btn { padding: 15px 40px; border-radius: 50px; font-weight: 700; text-transform: uppercase; font-size: 12px; letter-spacing: 2px; transition: 0.3s; cursor: pointer; border: none; }
...
/* --- ABOUT / FEATURES / MEDIA CARDS / STATS --- */
.about-grid, .features-grid, .stats-grid, .media-scroller { display: grid; gap: 30px; }
.features-grid { grid-template-columns: repeat(auto-fit, minmax(250px,1fr)); margin-top: 50px; }
.feature-box { background: var(--glass); padding: 30px; border-radius: 15px; border: 1px solid var(--border-glass); transition: 0.3s; }
