...
.stars{color:#ffca08}
.btn-delete{color:#ff4d4d;border:1px solid #ff4d4d;padding:6px 10px;border-radius:6px;text-decoration:none;transition:.3s}
.btn-delete:hover{background:#ff4d4d;color:#fff;box-shadow:0 0 10px rgba(255,77,77,.4)}
.alert-custom{background:#1a1a1a;border-left:4px solid #28a745;color:#fff;font-size:.9rem}
</style>
</head>
...
Album <span style="color:var(--accent)">Reviews</span>
</h4>
<a href="index.php" class="btn btn-outline-light btn-sm px-3">Dashboard</a>
</div>

<?php if(isset($_GET['status']) && $_GET['status']=='deleted'): ?>
<div class="alert alert-custom alert-dismissible fade show shadow">
<i class="bi bi-check-circle-fill text-success me-2"></i>
<strong>Success!</strong> Review has been permanently removed.
...
<img src="uploads/albums/<?= htmlspecialchars($row['cover'] ?: 'default.jpg') ?>" class="album-img me-3">
...
<span class="text-muted" style="font-size:.75rem"><?= (int)$row['rating'] ?>/5</span>
</td>
...
class="btn-delete"
onclick="return confirm('Are you sure? This will permanently delete the review.');">
...
No reviews available in the database.
</td>
</tr>
<?php endif; ?>
</tbody>
