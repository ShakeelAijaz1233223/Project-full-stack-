...
$query = "SELECT video_reviews.*, videos.title AS v_title
          ...
          ORDER BY video_reviews.created_at DESC";
...
/* Rating */
.stars { color: #ffca08; font-size: .9rem; }
.star-off { color: #222; }
...
<div class="container admin-wrapper">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h3 class="page-title m-0">VIDEO <span class="accent-glow">REVIEWS</span></h3>
            <p class="text-muted small m-0 mt-1">Moderation panel for visual content feedback</p>
        </div>
            ...
            <table class="table table-dark mb-0">
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                                                <img src="uploads/video_thumbnails/<?= $row['thumbnail'] ?>" class="album-img" onerror="this.src='https://via.placeholder.com/48/111/fff?text=No+Img'">
                                                <div>
                ...
                <tr>
                    <td colspan="5" class="text-center py-5 text-muted">
                        No video reviews found in the system.
                    </td>
                </tr>
