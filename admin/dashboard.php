...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav>
            ...
            <a href="music_reviews.php"><i class="fa-solid fa-envelope-open-text"></i> Music_Review</a>
            <a href="video_reviews.php"><i class="fa-solid fa-envelope-open-text"></i> Video_Review</a>
