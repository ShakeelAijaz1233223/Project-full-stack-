...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2026 at 07:34 PM
...
CREATE TABLE `music` (
  ...
  `artist` varchar(100) NOT NULL DEFAULT 'Admin',
...
INSERT INTO `music` (`id`, `title`, `artist`, `file`, `created_at`, `status`, `likes`, `reviews`, `cover_image`, `full_cover_image_path`) VALUES
(5, 'asdf', 'Admin', '1769448821_7fd3b6233f6f0057c513a0b335c7c609.mp3', '2026-01-26 17:33:41', 'public', 0, NULL, 'default_music.png', NULL);
...
(1, 'SHAKEEL AHMED', 'shakeel@gmail.com', '', '', '$2y$10$sbC5OVaVQ306V7k4QpqLSOo54nXhAg8Vr/J8UEOhPa3zSU2gERjYC', 'admin', 'active', 'avatar_1.jpg', '2026-01-23 16:12:05', 'default.png'),
(2, 'shakeel', 'shakeeladmin@gmail.com', '', NULL, '$2y$10$I2FykeG3kwMOkMq6lS.IzO7zrad2PPw0KmZuwOdypsSuGsgJ.Yryu', 'user', 'active', '', '2026-01-23 17:00:00', 'default.png');
